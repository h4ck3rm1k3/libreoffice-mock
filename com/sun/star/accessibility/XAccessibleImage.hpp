...
struct theXAccessibleImageType : public rtl::StaticWithInit< ::css::uno::Type *, theXAccessibleImageType >
{
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::accessibility::XAccessibleImage const *) {
    const ::css::uno::Type &rRet = *detail::theXAccessibleImageType::get();
...
inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::accessibility::XAccessibleImage > const *) SAL_THROW(()) {
...
::css::uno::Type const & ::css::accessibility::XAccessibleImage::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::getCppuType(static_cast< ::css::uno::Reference< ::css::accessibility::XAccessibleImage > * >(0));
}
