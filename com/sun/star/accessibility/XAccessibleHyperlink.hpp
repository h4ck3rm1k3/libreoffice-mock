...
struct theXAccessibleHyperlinkType : public rtl::StaticWithInit< ::css::uno::Type *, theXAccessibleHyperlinkType >
{
    ::css::uno::Type * operator()() const
    {
        ...
        aSuperTypes[0] = ::cppu::UnoType< ::css::uno::Reference< ::css::accessibility::XAccessibleAction > >::get().getTypeLibType();
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::accessibility::XAccessibleHyperlink const *) {
    const ::css::uno::Type &rRet = *detail::theXAccessibleHyperlinkType::get();
...
inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::accessibility::XAccessibleHyperlink > const *) SAL_THROW(()) {
...
::css::uno::Type const & ::css::accessibility::XAccessibleHyperlink::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::getCppuType(static_cast< ::css::uno::Reference< ::css::accessibility::XAccessibleHyperlink > * >(0));
}
