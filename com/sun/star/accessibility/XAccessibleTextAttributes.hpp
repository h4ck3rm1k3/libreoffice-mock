...
struct theXAccessibleTextAttributesType : public rtl::StaticWithInit< ::css::uno::Type *, theXAccessibleTextAttributesType >
{
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::accessibility::XAccessibleTextAttributes const *) {
    const ::css::uno::Type &rRet = *detail::theXAccessibleTextAttributesType::get();
...
inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::accessibility::XAccessibleTextAttributes > const *) SAL_THROW(()) {
...
::css::uno::Type const & ::css::accessibility::XAccessibleTextAttributes::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::getCppuType(static_cast< ::css::uno::Reference< ::css::accessibility::XAccessibleTextAttributes > * >(0));
}
