...
struct theXAccessibleEditableTextType : public rtl::StaticWithInit< ::com::sun::star::uno::Type *, theXAccessibleEditableTextType >
{
...
// inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::com::sun::star::accessibility::XAccessibleEditableText const *) {
//     const ::com::sun::star::uno::Type &rRet = *detail::theXAccessibleEditableTextType::get();
...
//                 aParameters[0].pParamName = sParamName0.pData;
//                 aParameters[0].eTypeClass = (typelib_TypeClass)::com::sun::star::uno::TypeClass_STRING;
//                 aParameters[0].pTypeName = sParamType0.pData;
//                 aParameters[0].bIn = sal_True;
//                 aParameters[0].bOut = sal_False;
...
//                 aParameters[2].eTypeClass = (typelib_TypeClass)::com::sun::star::uno::TypeClass_STRING;
...
//                 aParameters[2].pParamName = sParamName2.pData;
//                 aParameters[2].eTypeClass = (typelib_TypeClass)::com::sun::star::uno::TypeClass_SEQUENCE;
//                 aParameters[2].pTypeName = sParamType2.pData;
//                 aParameters[2].bIn = sal_True;
//                 aParameters[2].bOut = sal_False;
//                 ::rtl::OUString the_ExceptionName0( "com.sun.star.lang.IndexOutOfBoundsException" );
...
//                     25, sal_False,
//                     sMethodName5.pData,
//                     (typelib_TypeClass)::com::sun::star::uno::TypeClass_BOOLEAN, sReturnType5.pData,
//                     3, aParameters,
//                     2, the_Exceptions );
//                 typelib_typedescription_register( (typelib_TypeDescription**)&pMethod );
//             }
...
//                     26, sal_False,
//                     sMethodName6.pData,
//                     (typelib_TypeClass)::com::sun::star::uno::TypeClass_BOOLEAN, sReturnType6.pData,
//                     1, aParameters,
//                     1, the_Exceptions );
//                 typelib_typedescription_register( (typelib_TypeDescription**)&pMethod );
//             }
...
// inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::com::sun::star::uno::Reference< ::com::sun::star::accessibility::XAccessibleEditableText > const *)  {
//     return ::cppu::UnoType< ::com::sun::star::uno::Reference< ::com::sun::star::accessibility::XAccessibleEditableText > >::get();
// }

// ::com::sun::star::uno::Type const & ::com::sun::star::accessibility::XAccessibleEditableText::static_type(SAL_UNUSED_PARAMETER void *) {
