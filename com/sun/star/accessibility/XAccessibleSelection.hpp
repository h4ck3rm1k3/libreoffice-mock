...
struct theXAccessibleSelectionType : public rtl::StaticWithInit< ::css::uno::Type *, theXAccessibleSelectionType >
{
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::accessibility::XAccessibleSelection const *) {
    const ::css::uno::Type &rRet = *detail::theXAccessibleSelectionType::get();
...
inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::accessibility::XAccessibleSelection > const *) SAL_THROW(()) {
...
::css::uno::Type const & ::css::accessibility::XAccessibleSelection::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::getCppuType(static_cast< ::css::uno::Reference< ::css::accessibility::XAccessibleSelection > * >(0));
}
