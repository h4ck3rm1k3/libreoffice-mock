...
struct theXAccessibleEventBroadcasterType : public rtl::StaticWithInit< ::css::uno::Type *, theXAccessibleEventBroadcasterType >
{
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::accessibility::XAccessibleEventBroadcaster const *) {
    const ::css::uno::Type &rRet = *detail::theXAccessibleEventBroadcasterType::get();
...
inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::accessibility::XAccessibleEventBroadcaster > const *) SAL_THROW(()) {
...
::css::uno::Type const & ::css::accessibility::XAccessibleEventBroadcaster::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::getCppuType(static_cast< ::css::uno::Reference< ::css::accessibility::XAccessibleEventBroadcaster > * >(0));
}
