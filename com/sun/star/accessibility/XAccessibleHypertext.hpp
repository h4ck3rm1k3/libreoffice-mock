...
struct theXAccessibleHypertextType : public rtl::StaticWithInit< ::com::sun::star::uno::Type *, theXAccessibleHypertextType >
{
...
// inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::com::sun::star::accessibility::XAccessibleHypertext const *) {
//     const ::com::sun::star::uno::Type &rRet = *detail::theXAccessibleHypertextType::get();
...
// inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::com::sun::star::uno::Reference< ::com::sun::star::accessibility::XAccessibleHypertext > const *)  {
//     return ::cppu::UnoType< ::com::sun::star::uno::Reference< ::com::sun::star::accessibility::XAccessibleHypertext > >::get();
// }

// ::com::sun::star::uno::Type const & ::com::sun::star::accessibility::XAccessibleHypertext::static_type(SAL_UNUSED_PARAMETER void *) {
