...
struct theXAccessibleRelationSetType : public rtl::StaticWithInit< ::css::uno::Type *, theXAccessibleRelationSetType >
{
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::accessibility::XAccessibleRelationSet const *) {
    const ::css::uno::Type &rRet = *detail::theXAccessibleRelationSetType::get();
        ...
        if (!bInitStarted)
        {
            ...
            }
            {
                ...
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    6, sal_False,
                    sMethodName3.pData,
                    (typelib_TypeClass)::css::uno::TypeClass_STRUCT, sReturnType3.pData,
                    1, aParameters,
                    1, the_Exceptions );
                typelib_typedescription_register( (typelib_TypeDescription**)&pMethod );
            }
...
inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::accessibility::XAccessibleRelationSet > const *) SAL_THROW(()) {
...
::css::uno::Type const & ::css::accessibility::XAccessibleRelationSet::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::getCppuType(static_cast< ::css::uno::Reference< ::css::accessibility::XAccessibleRelationSet > * >(0));
}
