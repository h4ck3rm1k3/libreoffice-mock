...
struct theXAccessibleKeyBindingType : public rtl::StaticWithInit< ::com::sun::star::uno::Type *, theXAccessibleKeyBindingType >
{
    ::com::sun::star::uno::Type * operator()() const
    {
        ::rtl::OUString sTypeName( "com.sun.star.accessibility.XAccessibleKeyBinding" );
        ...
        // ::rtl::OUString sMethodName0( "com.sun.star.accessibility.XAccessibleKeyBinding::getAccessibleKeyBindingCount" );
        // typelib_typedescriptionreference_new( &pMembers[0],
        //                                       (typelib_TypeClass)::com::sun::star::uno::TypeClass_INTERFACE_METHOD,
        //                                       sMethodName0.pData );
        // ::rtl::OUString sMethodName1( "com.sun.star.accessibility.XAccessibleKeyBinding::getAccessibleKeyBinding" );
...
// inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::com::sun::star::accessibility::XAccessibleKeyBinding const *) {
//     const ::com::sun::star::uno::Type &rRet = *detail::theXAccessibleKeyBindingType::get();
...
//                 ::rtl::OUString sReturnType1( "[]com.sun.star.awt.KeyStroke" );
//                 ::rtl::OUString sMethodName1( "com.sun.star.accessibility.XAccessibleKeyBinding::getAccessibleKeyBinding" );
//                 typelib_typedescription_newInterfaceMethod( &pMethod,
//                     4, sal_False,
//                     sMethodName1.pData,
...
// inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::com::sun::star::uno::Reference< ::com::sun::star::accessibility::XAccessibleKeyBinding > const *)  {
//     return ::cppu::UnoType< ::com::sun::star::uno::Reference< ::com::sun::star::accessibility::XAccessibleKeyBinding > >::get();
// }

// ::com::sun::star::uno::Type const & ::com::sun::star::accessibility::XAccessibleKeyBinding::static_type(SAL_UNUSED_PARAMETER void *) {
//     return ::getCppuType(static_cast< ::com::sun::star::uno::Reference< ::com::sun::star::accessibility::XAccessibleKeyBinding > * >(0));
// }
