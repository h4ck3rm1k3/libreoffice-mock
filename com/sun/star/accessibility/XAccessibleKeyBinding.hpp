...
struct theXAccessibleKeyBindingType : public rtl::StaticWithInit< ::css::uno::Type *, theXAccessibleKeyBindingType >
{
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::accessibility::XAccessibleKeyBinding const *) {
    const ::css::uno::Type &rRet = *detail::theXAccessibleKeyBindingType::get();
...
inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::accessibility::XAccessibleKeyBinding > const *) SAL_THROW(()) {
...
::css::uno::Type const & ::css::accessibility::XAccessibleKeyBinding::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::getCppuType(static_cast< ::css::uno::Reference< ::css::accessibility::XAccessibleKeyBinding > * >(0));
}
