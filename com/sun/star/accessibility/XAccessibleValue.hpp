...
struct theXAccessibleValueType : public rtl::StaticWithInit< ::css::uno::Type *, theXAccessibleValueType >
{
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::accessibility::XAccessibleValue const *) {
    const ::css::uno::Type &rRet = *detail::theXAccessibleValueType::get();
...
inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::accessibility::XAccessibleValue > const *) SAL_THROW(()) {
...
::css::uno::Type const & ::css::accessibility::XAccessibleValue::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::getCppuType(static_cast< ::css::uno::Reference< ::css::accessibility::XAccessibleValue > * >(0));
}
