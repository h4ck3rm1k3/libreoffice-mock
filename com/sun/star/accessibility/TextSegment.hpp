...
struct theTextSegmentType : public rtl::StaticWithInit< ::com::sun::star::uno::Type *, theTextSegmentType >
{
...
// inline ::com::sun::star::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::com::sun::star::accessibility::TextSegment const *) {
//     return *detail::theTextSegmentType::get();
// }

// } } } }

// inline ::com::sun::star::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::com::sun::star::accessibility::TextSegment const *)  {
