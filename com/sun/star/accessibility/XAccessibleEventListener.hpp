...
struct theXAccessibleEventListenerType : public rtl::StaticWithInit< ::css::uno::Type *, theXAccessibleEventListenerType >
{
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::accessibility::XAccessibleEventListener const *) {
    const ::css::uno::Type &rRet = *detail::theXAccessibleEventListenerType::get();
...
inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::accessibility::XAccessibleEventListener > const *) SAL_THROW(()) {
...
::css::uno::Type const & ::css::accessibility::XAccessibleEventListener::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::getCppuType(static_cast< ::css::uno::Reference< ::css::accessibility::XAccessibleEventListener > * >(0));
}
