...
struct theXMSAAServiceType : public rtl::StaticWithInit< ::css::uno::Type *, theXMSAAServiceType >
{
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::accessibility::XMSAAService const *) {
    const ::css::uno::Type &rRet = *detail::theXMSAAServiceType::get();
    ...
    if (!bInitStarted)
    {
        ...
        if (!bInitStarted)
        {
            ...
            typelib_InterfaceMethodTypeDescription * pMethod = 0;
            {
                ...
                aParameters[2].eTypeClass = (typelib_TypeClass)::css::uno::TypeClass_HYPER;
                ...
                typelib_typedescription_newInterfaceMethod( &pMethod,
                    6, sal_False,
                    sMethodName0.pData,
                    (typelib_TypeClass)::css::uno::TypeClass_HYPER, sReturnType0.pData,
                    3, aParameters,
                    1, the_Exceptions );
...
inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::accessibility::XMSAAService > const *) SAL_THROW(()) {
...
::css::uno::Type const & ::css::accessibility::XMSAAService::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::getCppuType(static_cast< ::css::uno::Reference< ::css::accessibility::XMSAAService > * >(0));
}
