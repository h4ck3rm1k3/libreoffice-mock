...
struct theXAccessibleTextMarkupType : public rtl::StaticWithInit< ::css::uno::Type *, theXAccessibleTextMarkupType >
{
...
inline ::css::uno::Type const & cppu_detail_getUnoType(SAL_UNUSED_PARAMETER ::css::accessibility::XAccessibleTextMarkup const *) {
    const ::css::uno::Type &rRet = *detail::theXAccessibleTextMarkupType::get();
...
inline ::css::uno::Type const & SAL_CALL getCppuType(SAL_UNUSED_PARAMETER ::css::uno::Reference< ::css::accessibility::XAccessibleTextMarkup > const *) SAL_THROW(()) {
...
::css::uno::Type const & ::css::accessibility::XAccessibleTextMarkup::static_type(SAL_UNUSED_PARAMETER void *) {
    return ::getCppuType(static_cast< ::css::uno::Reference< ::css::accessibility::XAccessibleTextMarkup > * >(0));
}
